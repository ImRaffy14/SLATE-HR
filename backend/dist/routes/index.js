...
const dashboard_routes_1 = __importDefault(require("./v1/dashboard.routes"));
...
const performance_routes_1 = __importDefault(require("../modules/performance/routes/performance.routes"));
...
router.use('/dashboard', verifyToken_1.verifyToken, dashboard_routes_1.default);
...
router.use('/performance', verifyToken_1.verifyToken, performance_routes_1.default);
