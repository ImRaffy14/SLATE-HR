...
flowchart TB
    ...
    Learning --> Succession
    Training --> Succession### Key Features at a Glance
...
flowchart TD
    ...
    MoreLearning --> Course
    Continue --> Course### Process Steps Explained
...
flowchart LR
    ...
    ESS --> Notifications[Notifications Tab]### 4.1 Dashboard Tab
...
flowchart TD
    ...
    Certificate --> Update[Competency & Progress Updated]### For HR (Admin Panel)
...
flowchart TD
    ...
    Present --> Complete[Training Completed]### For HR
...
flowchart TD
    ...
    Gaps --> Development[Recommend Courses & Trainings]### For HR
...
flowchart TD
    ...
    Summary --> Actions[Recommendations for Action]### For Managers
...
flowchart TD
    ...
    Promotion --> Alert[Send Promotion Alert]### Main Screens
...
flowchart TD
    ...
    Activity --> Feed[Recent System Activities]### What It’s Used For
...
flowchart LR
    ...
    Learning --> Dash
    Training --> Dash
    Comp --> Dash### IDP Progress Automation Flow
maid
flowchart TD
